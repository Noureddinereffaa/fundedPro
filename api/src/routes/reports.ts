...
router.get('/daily/:accountId', authenticate, async (req, res) => {
  try {
...
router.get('/equity/:accountId', authenticate, async (req, res) => {
  try {
...
router.get('/stats/:accountId', authenticate, async (req, res) => {
  try {
...
router.get('/symbols/:accountId', authenticate, async (req, res) => {
  try {
